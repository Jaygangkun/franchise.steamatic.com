...
function primer_scripts_and_styles() {
  if (!is_admin()) {
    ...
    // fancybox stylesheet
    wp_register_style( 'fancybox-stylesheet', get_stylesheet_directory_uri() . '/library/css/fancybox.min.css', array(), '', 'all' );
    ...
    // fancybox js
    wp_register_script( 'fancybox-js', get_stylesheet_directory_uri() . '/library/js/fancybox.min.js', array( 'jquery' ), '', true );
